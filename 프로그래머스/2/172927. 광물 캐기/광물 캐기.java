...
class Solution {
    static int[][] fatigueInfo;
    static List<Mineral> list;
    
    public int solution(int[] picks, String[] minerals) {
        int answer = 0;
        
        fatigueInfo = new int[][]{{1, 1, 1},{5, 1, 1},{25, 5, 1}};
        ...
        for(int i = 0; i < minerals.length; i += 5){
            ...
            for(int j = i; j < i + 5; j++){
                ...
                int val = 0;
                if(mineral.equals("iron")) val = 1;
                else if(mineral.equals("stone")) val = 2;
                
                dia += fatigueInfo[0][val];
                iron += fatigueInfo[1][val];
                stone += fatigueInfo[2][val];
            }
