...
public class Main {
    ...
    private static int BFS() {
        ...
        visited[0][0][0] = true;
        dq.offer(new int[] {0, 0, 1, 0, 0}); // r, c, 이동거리, 벽을 부신 횟수, 낮
            ...
            for(int d = 0; d < 4; d++){
                ...
                if(map[nr][nc] == 1 && breakCnt < K && !visited[nr][nc][breakCnt + 1]){
                    ...
                    if(day == 0){
                        ...
                        dq.offer(new int[] {nr, nc, moveCnt + 1, breakCnt + 1, 1});
                    }

                    // 밤이면 머무르기
                    else{
                        dq.offer(new int[] {cur[0], cur[1], moveCnt + 1, breakCnt, 0});
                    }
                }
                ...
                if(map[nr][nc] == 0 && !visited[nr][nc][breakCnt]){
                    ...
                    if(day == 0){
                        ...
                        visited[nr][nc][breakCnt] = true;
                        dq.offer(new int[] {nr, nc, moveCnt + 1, breakCnt, 0});
                    }
                }
